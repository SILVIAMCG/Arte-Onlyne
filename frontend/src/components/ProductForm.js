...
import {Container, Row, Col, Button, ListGroup, Image, ListGroupItem, Modal} from 'react-bootstrap';
                ...
                {productsFromSeller.map((product) => (
                    <ListGroupItem key={product._id} className="py-2 px-3">
                        <Row className="align-items-center">
                            ...
                            <Col md={2}>
                                <p className="text-sm-center">Estado: {product.status}</p>
                            </Col>
                            ...
                            <Col md={2}>
                                <div className="d-flex justify-content-center justify-content-md-start gap-4">
                                    ...
                                    >
                                        <FaPencilAlt className="me-2" /> Actualizar
                                    </Button>
                                    <Button
                                    variant="danger"
                                    className="d-flex align-items-center"
                ...
                <Modal show={show} onHide={handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>
                            ...
                            ? `Estas actualizando el producto id: ${productToUpdate._id} `
                    ...
                    {/* Componente que recibe los datos para actualizar o para crear un nuevo producto */}
                        ...
                        closeHandle={setShow}
                        productoToFalse={setProductToUpdate}
                        />
                    </Modal.Body>
                    <Modal.Footer>
